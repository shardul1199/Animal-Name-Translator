...
namespace Speech_Project {
	...
	/// <summary>
	/// Summary for InputForm1
	
	/// </summary>
	
	public ref class InputForm1 : public System::Windows::Forms::Form
	{
	private:
		Form^ parent;
...
//===========================================================================
  ...
  void live_train(char* foldername)
 {
	 ...
	 FILE* source_file=fopen("testdata/threshold.txt","r");
	 fscanf(source_file,"%Lf",&val);
	 fprintf(target_file,"%Lf",val);
	 fclose(target_file);
	 fclose(source_file);
	 ...
	 sprintf(command,"mkdir live_models\\%s\\observation",foldername);
	 system(command);
	 ...
	 for(i=1;i<=words;i++)
	 {
		 ...
		 sprintf(command,"mkdir live_models\\%s\\observation\\%d",foldername,i);
		 system(command);
    ...
    for(itr1=1;itr1<=words;itr1++)
   {
	...
	private: System::Windows::Forms::Label^  lblNumUtter;
	protected: 
	...
	private: System::Windows::Forms::NumericUpDown^  numUtter;
...
#pragma region Windows Form Designer generated code
		...
		{
			this->lblNumWords = (gcnew System::Windows::Forms::Label());
			this->lblNumUtter = (gcnew System::Windows::Forms::Label());
			this->button1 = (gcnew System::Windows::Forms::Button());
			this->numWords = (gcnew System::Windows::Forms::NumericUpDown());
			this->numUtter = (gcnew System::Windows::Forms::NumericUpDown());
			this->lblName = (gcnew System::Windows::Forms::Label());
			this->txtName = (gcnew System::Windows::Forms::TextBox());
			this->btnTrain = (gcnew System::Windows::Forms::Button());
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^  >(this->numWords))->BeginInit();
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^  >(this->numUtter))->BeginInit();
			this->SuspendLayout();
			// 
			// lblNumWords
			// 
			this->lblNumWords->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 14.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->lblNumWords->Location = System::Drawing::Point(44, 138);
			this->lblNumWords->Name = L"lblNumWords";
			this->lblNumWords->Size = System::Drawing::Size(163, 60);
			this->lblNumWords->TabIndex = 0;
			this->lblNumWords->Text = L"Enter number of words  to record";
			// 
			// lblNumUtter
			// 
			this->lblNumUtter->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 14.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->lblNumUtter->Location = System::Drawing::Point(44, 219);
			this->lblNumUtter->Name = L"lblNumUtter";
			this->lblNumUtter->Size = System::Drawing::Size(143, 49);
			this->lblNumUtter->TabIndex = 3;
			this->lblNumUtter->Text = L"Enter number of utterances";
			// 
			// button1
			// 
			...
			this->button1->Font = (gcnew System::Drawing::Font(L"Comic Sans MS", 14.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->button1->ForeColor = System::Drawing::Color::White;
			this->button1->Location = System::Drawing::Point(128, 319);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(89, 36);
			this->button1->TabIndex = 4;
			this->button1->Text = L"S&ubmit";
			this->button1->UseVisualStyleBackColor = false;
			this->button1->Click += gcnew System::EventHandler(this, &InputForm1::button1_Click);
			// 
			// numWords
			// 
			this->numWords->Location = System::Drawing::Point(240, 144);
			this->numWords->Minimum = System::Decimal(gcnew cli::array< System::Int32 >(4) {1, 0, 0, 0});
			this->numWords->Name = L"numWords";
			this->numWords->Size = System::Drawing::Size(120, 20);
			this->numWords->TabIndex = 5;
			this->numWords->Value = System::Decimal(gcnew cli::array< System::Int32 >(4) {1, 0, 0, 0});
			// 
			// numUtter
			// 
			this->numUtter->Location = System::Drawing::Point(240, 225);
			this->numUtter->Minimum = System::Decimal(gcnew cli::array< System::Int32 >(4) {1, 0, 0, 0});
			this->numUtter->Name = L"numUtter";
			this->numUtter->Size = System::Drawing::Size(120, 20);
			this->numUtter->TabIndex = 6;
			this->numUtter->Value = System::Decimal(gcnew cli::array< System::Int32 >(4) {1, 0, 0, 0});
			// 
			// lblName
			// 
			this->lblName->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 14.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->lblName->Location = System::Drawing::Point(48, 69);
			this->lblName->Name = L"lblName";
			this->lblName->Size = System::Drawing::Size(159, 38);
			this->lblName->TabIndex = 7;
			this->lblName->Text = L"Enter Your Name";
			// 
			// txtName
			// 
			this->txtName->BackColor = System::Drawing::SystemColors::ControlLightLight;
			this->txtName->Location = System::Drawing::Point(240, 69);
			this->txtName->Name = L"txtName";
			this->txtName->Size = System::Drawing::Size(179, 20);
			this->txtName->TabIndex = 8;
			// 
			// btnTrain
			// 
			this->btnTrain->BackColor = System::Drawing::Color::Lime;
			this->btnTrain->Enabled = false;
			this->btnTrain->Font = (gcnew System::Drawing::Font(L"Comic Sans MS", 14.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->btnTrain->ForeColor = System::Drawing::Color::White;
			this->btnTrain->Location = System::Drawing::Point(288, 319);
			this->btnTrain->Name = L"btnTrain";
			this->btnTrain->Size = System::Drawing::Size(96, 36);
			this->btnTrain->TabIndex = 9;
			this->btnTrain->Text = L"T&rain";
			this->btnTrain->UseVisualStyleBackColor = false;
			this->btnTrain->Click += gcnew System::EventHandler(this, &InputForm1::btnTrain_Click);
			// 
			// InputForm1
			// 
			...
			this->ClientSize = System::Drawing::Size(545, 409);
			this->Controls->Add(this->btnTrain);
			this->Controls->Add(this->txtName);
			this->Controls->Add(this->lblName);
			this->Controls->Add(this->numUtter);
			this->Controls->Add(this->numWords);
			this->Controls->Add(this->button1);
			this->Controls->Add(this->lblNumUtter);
			this->Controls->Add(this->lblNumWords);
			this->MaximizeBox = false;
			this->MinimizeBox = false;
			this->Name = L"InputForm1";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"InputForm";
			this->FormClosed += gcnew System::Windows::Forms::FormClosedEventHandler(this, &InputForm1::InputForm1_FormClosed);
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^  >(this->numWords))->EndInit();
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^  >(this->numUtter))->EndInit();
...
#pragma endregion
	private: System::Void InputForm1_FormClosed(System::Object^  sender, System::Windows::Forms::FormClosedEventArgs^  e) {
				 parent->Show();
			 }
...
private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
			...
			//time_t _tm =time(NULL);
			 ...
			 if(txtName->Text->Trim()->Length > 0) name = txtName->Text;
			 else isValid = false;
			 if(isValid)
			 {
				 words = numWords->Value;
				 utterances = numUtter->Value;
				if(name != "default"){
				if(MessageBox::Show("User Name : "+name+"\nNum Words :"+words+"\nNum Utterances : "+utterances+"\nAre You Sure Want to Proceed ?","User Data",MessageBoxButtons::YesNo,MessageBoxIcon::Question) == System::Windows::Forms::DialogResult::Yes)
				{
					Console::WriteLine("Success");
					userData^ udat = gcnew userData();
					udat->setName(name);
					udat->setNumWords(words);
					udat->setNumUtterances(utterances);
					/*pin_ptr<const wchar_t> command1 = PtrToStringChars("mkdir "+name);
					size_t origsize1 = wcslen(command1) + 1;
					const size_t newsize1 = origsize1 * 2;
					size_t convertedChars1 = 0;
					char* nstring1 = new char[newsize1];
					wcstombs_s(&convertedChars1, nstring1, newsize1, command1, _TRUNCATE);
					//cout << nstring << " (char *)" << endl;
					 system(nstring1);
					pin_ptr<const wchar_t> command2 = PtrToStringChars("cd "+name);
					size_t origsize2 = wcslen(command2) + 1;
					const size_t newsize2 = origsize2 * 2;
					size_t convertedChars2 = 0;
					char* nstring2 = new char[newsize2];
					wcstombs_s(&convertedChars2, nstring2, newsize2, command2, _TRUNCATE);
					//cout << nstring << " (char *)" << endl;
					system(nstring2);
					delete []nstring1;
					delete []nstring2;*/
					char *command = StringToChar("mkdir live_models\\"+name);
					system(command);
					delete []command;
					command = StringToChar("live_models/"+name+"/num_words.txt");
					FILE *fp = fopen(command,"w");
					delete []command;
					fprintf(fp,"%d",Convert::ToInt32(words));
					fclose(fp);
					command = StringToChar("live_models/"+name+"/num_utterances.txt");
					fp = fopen(command,"w");
					delete []command;
					fprintf(fp,"%d",Convert::ToInt32(utterances));
					fclose(fp);
					char str[20];
					String^ converted;
					int numw = Convert::ToInt32(words),i;
					
					for(i = 1; i <= numw; i++)
					{
						
						sprintf(str,"%d",i);
						converted = msclr::interop::marshal_as<System::String^>(str);
						command = StringToChar("mkdir live_models\\"+name+"\\"+converted);
						
						system(command);
						delete []command;
					}
					WordForm^ wform;
					remove(StringToChar("live_models/"+name+"/vocab.txt"));
					for(i = 1; i <= numw; i++)
					{
						
						sprintf(str,"%d",i);
						converted = msclr::interop::marshal_as<System::String^>(str);
						//command = StringToCharI("mkdir live_models\\"+name+"\\"+converted);
						udat->setWordIndex(converted);
						wform = gcnew WordForm(this,udat);
						this->Hide();
						wform->ShowDialog();
					...
					numWords->Enabled = false;
					numUtter->Enabled = false;
				...
				else
				{
					...
					MessageBox::Show("User Name Can't be default","Error",MessageBoxButtons::OK,MessageBoxIcon::Error);
				}
			 }
			...
			/*char command[300];
			sprintf(command,"mkdir %u",_tm);
			system(command);*/
		 }
private: System::Void btnTrain_Click(System::Object^  sender, System::EventArgs^  e) {
			 //Code for training
			 if(MessageBox::Show("Training may take few minutes.\nAre You Sure Want to Proceed ?","Training",MessageBoxButtons::YesNo,MessageBoxIcon::Question) == System::Windows::Forms::DialogResult::Yes)
			 {
				 char *folder = StringToChar(txtName->Text);
				 live_train(folder);
				 delete []folder;
				 MessageBox::Show("Training Completed....");
				 FILE *fp = fopen(StringToChar("live_models/"+txtName->Text+"/trained.txt"),"w");
				 fclose(fp);
			 }
			 
			
				    txtName->Enabled = true;
					numWords->Enabled = true;
					numUtter->Enabled = true;
					btnTrain->Enabled = false;
					button1->Enabled = true;
					txtName->Text = "";
					numWords->Value = numWords->Minimum;
					numUtter->Value = numUtter->Minimum;
